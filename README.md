...
**Live demo → https://bswxyz.github.io/fable-contour/** · [How it was built](https://bswxyz.github.io/fable-contour/guide/)
...
```bash
gh repo create my-site --template bswxyz/fable-contour --public --clone
cd my-site
